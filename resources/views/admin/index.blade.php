...
@section('content')
    <div class="col-lg-4 col-6 ">
        <div class="small-box border-left-primary">
            <div class="inner">
                <a href="{{ route('jadwal.index') }}" class="aa">
                    <h3>{{ $jadwal }}</h3>
                </a>
                <p class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jadwal</p>
            </div>
            <div class="icon">
    ...
    <div class="col-lg-4 col-6">
        <div class="small-box border-left-warning">
            <div class="inner" style="">
                <a href="{{ route('guru.index') }}" class="aa">
                    <h3>{{ $guru }}</h3>
                </a>
                <p class="text-xs font-weight-bold text-warning text-uppercase mb-1">Guru</p>
            </div>
            <div class="icon">
    ...
    <div class="col-lg-4 col-6">
        <div class="small-box border-left-success">
            <div class="inner">
                <a href="{{ route('siswa.index') }}" class="aa">
                    <h3>{{ $siswa }}</h3>
                </a>
                <p class="text-xs font-weight-bold text-success text-uppercase mb-1">Siswa</p>
            </div>
            <div class="icon">
                <i class="fas fa-id-card nav-icon"></i>
            </div>
    ...
    <div class="col-lg-4 col-6">
        <div class="small-box border-left-danger">
            <div class="inner">
                <a href="{{ route('kelas.index') }}" class="aa">
                    <h3>{{ $kelas }}</h3>
                </a>
                <p class="text-xs font-weight-bold text-danger text-uppercase mb-1">Kelas</p>
            </div>
            <div class="icon">
    ...
    <div class="col-lg-4 col-6">
        <div class="small-box border-left-info">
            <div class="inner">
                <a href="{{ route('mapel.index') }}" class="aa">
                    <h3>{{ $mapel }}</h3>
                </a>
                <p class="text-xs font-weight-bold text-info text-uppercase mb-1">Mapel</p>
            </div>
            <div class="icon">
    ...
    <div class="col-lg-4 col-6">
        <div class="small-box border-left-secondary">
            <div class="inner">
                <a href="{{ route('user.index') }}" class="aa">
                    <h3>{{ $user }}</h3>
                </a>
                <p class="text-xs font-weight-bold text-secondary text-uppercase mb-1">User Registrations</p>
            </div>
            <div class="icon">
                ...
                <div class="d-flex mb-4">
                    ...
                    <p class="ml-auto d-flex flex-column text-right">
                        <span class="text-success">
                            <i class="fas fa-arrow-up pr-1"></i> {{ $guru }}
                        </span>
                    </p>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex mb-4">
                    ...
                    <p class="ml-auto d-flex flex-column text-right">
                        <span class="text-success">
                            <i class="fas fa-arrow-up pr-1"></i> {{ $siswa }}
                        </span>
                    </p>
                </div>
                <div class="position-relative mb-4">
