            ...
            <div class="row my-2">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="text-right">
                        ...
                        <a href="{{ route('guru.export_excel') }}" class="btn btn-success btn-sm ml-2" target="_blank"><i class="nav-icon fas fa-file-export"></i> &nbsp; Export Excel</a>
            ...
            <tbody>
                @foreach ($mapel as $data)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('guru.mapel', Crypt::encrypt($data->id)) }}" class="btn btn-info btn-sm"><i class="nav-icon fas fa-search-plus"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
