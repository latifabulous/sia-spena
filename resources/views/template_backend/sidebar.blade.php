...
<aside class="main-sidebar sidebar-dark-primary">
    <!-- Brand Logo -->
    <a href="" class="brand-link bg-col" style="">
        <img src="{{ asset('img/favicon.png') }}" alt="Admin Logo" class="brand-image img-circle ml-5">
        <span class="brand-text fW-700">SPENA</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar bg-col px-0">
        <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                @if (Auth::user()->role == 'Admin' || Auth::user()->role == 'Operator')
                    <li class="nav-item has-treeview mt-3" id="liDashboard">
                        <a href="#" class="nav-link" id="Dashboard">
                            <i class="nav-icon fas fa-home"></i>
                            <p>
                                Dashboard
                            </p>
                            <i class="fas fa-angle-left right pt-2 pr-2"></i>
                        </a>
