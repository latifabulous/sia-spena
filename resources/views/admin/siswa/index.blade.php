            ...
            <div class="row my-2">
                ...
                <div class="col-sm-8">
                  <div class="text-right">
                    <a href="{{ route('siswa.export_excel') }}" class="btn btn-success btn-sm" target="_blank"><i class="nav-icon fas fa-file-export"></i> &nbsp; Export Excel</a>
                <button type="button" class="btn btn-primary btn-sm mx-2" data-toggle="modal" data-target="#importExcel">
            ...
            <tbody>
                @foreach ($kelas as $data)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('siswa.kelas', Crypt::encrypt($data->id)) }}" class="btn btn-info btn-sm"><i class="nav-icon fas fa-search-plus"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
