  ...
  <div class="card">
    <div class="card-header">
      <div class="row my-2">
        ...
        <div class="col-sm-4">
          <button type="button" class="btn btn-default btn-sm ml-0" data-toggle="modal" data-target=".tambah-jadwal">
        ...
        <div class="col-sm-8">
            <div class="text-right">
                <a href="{{ route('jadwal.export_excel') }}" class="btn btn-success btn-sm" target="_blank"><i class="nav-icon fas fa-file-export"></i> &nbsp; Export Excel</a>
            <button type="button" class="btn btn-primary btn-sm ml-2" data-toggle="modal" data-target="#importExcel">
                <i class="nav-icon fas fa-file-import"></i> &nbsp; Import Excel
            </button>
            <button type="button" class="btn btn-danger btn-sm ml-2" data-toggle="modal" data-target="#dropTable">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
							<button type="submit" class="btn btn-primary"><i class="nav-icon fas fa-file-import"></i> &nbsp; Import</button>
                </div>
              </div>
            </form>
          </div>
            ...
            <tbody>
                @foreach ($kelas as $data)
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('jadwal.show', Crypt::encrypt($data->id)) }}" class="btn btn-info btn-sm"><i class="nav-icon fas fa-search-plus"></i></a>
                    </td>
                  </tr>
                @endforeach
            </tbody>
...
<div class="modal fade bd-example-modal-lg tambah-jadwal" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
      <div class="modal-header">
          <h4 class="modal-title fw-700">Tambah Data Jadwal</h4>
